...
const u8        MASS_DeviceDescriptor[MASS_SIZ_DEVICE_DESC] =
{
   ...
   0x02,
   0x00,                        /*
                                 * bDeviceClass : each interface define the
                                 * device class 
                                 */
   0x00,                        /*
                                 * bDeviceSubClass 
   ...
   0x01,
   1,                           /*
                                 * index of string Manufacturer  
                                 */
    /**/
   2,                           /*
                                 * index of string descriptor of product
                                 */
   /*
    */
   3,                           /*
...
/******************** Descriptor of Mass Storage interface ********************/
   ...
   0x05,                        /*
                                 ...
                                 */
   0x02,                        /*
                                 * Endpoint address (OUT, address 2) 
                                 */
   0x02,                        /*
                                 * Bulk endpoint type 
                                 */
