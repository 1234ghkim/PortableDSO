...
* File Name: msd.c       Author: bure   Hardware: DS0201V1.1   Version: Ver 1.0
*******************************************************************************/
#include "msd.h"
...
/*******************************************************************************
 MicroSD Write Blocks                                   return: 0x00=success
*******************************************************************************/
...
/*******************************************************************************
 MicroSD Read Blocks                                   return: 0x00=success  
*******************************************************************************/
u8              MSD_ReadBuffer(u8 * pBuffer, u32 ReadAddr, u32 NumByteToRead)
{
   ...
   while (NbrOfBlock--)
   {
      MSD_SendCmd(MSD_READ_SINGLE_BLOCK, ReadAddr + Offset, 0xFF); // send
                                                                   // CMD17
...
u8              MSD_GetResponse(u8 Response)
{
   ...
   while ((MSD_ReadByte() != Response) && Count)
      Count--; // Check if response is got or a timeout is happen
