...
* File Name: scsi_data.c  Author: bure   Hardware: DS0201V1.1   Version: Ver 1.0
*******************************************************************************/
#include "usb_scsi.h"
#include "memory.h"
u8              Page00_Inquiry_Data[] =
{
   0x00,                        // PERIPHERAL QUALIFIER & PERIPHERAL DEVICE
                                // TYPE
    0x00,
   0x00,
   0x00,
...
u8              Standard_Inquiry_Data[] =
{
   ...
   36 - 4,                      // Additional Length 
    ...
    0x00,
   0x00,
   'e', '-', 'D', 'e', 's', 'i', 'g', 'n', ' ', 'D', 'S', 'O', // Vendor
                                                               // Identification 
                                                               // 
    ' ', 'F', 'l', 'a', 's', 'h', ' ', 'D', 'i', 's', 'k', ' ', // Product
                                                                // Identification 
                                                                // 
